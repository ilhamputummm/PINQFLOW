...
const EMPTY_DATA={
  transactions:[],
  budgets:{},
  settings:{savingsTarget:50,expenseMax:40},
      ...
      <div style={{borderRadius:20,overflow:"hidden",position:"relative",cursor:"grab",touchAction:"pan-y"}}
        ...
        <div ref={trackRef} style={{display:"flex",willChange:"transform",transition:dragging?"none":"transform 0.45s cubic-bezier(0.25,0.46,0.45,0.94)"}}>
          ...
          <div style={{minWidth:"100%",padding:"20px 22px",background:bg0,position:"relative",overflow:"hidden",boxSizing:"border-box"}}>
            ...
            <div style={{fontSize:11,color:"rgba(255,255,255,0.55)",fontWeight:700,letterSpacing:1,marginBottom:5}}>TOTAL BALANCE</div>
            <div style={{fontFamily:MONO,fontSize:28,fontWeight:900,color:"#fff",letterSpacing:-0.5,marginBottom:14,...blurStyle}}>{rp(totalBal)}</div>
            ...
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
              <div>
                <div style={{fontSize:10,color:"rgba(255,255,255,0.5)",fontWeight:600,marginBottom:3}}>NET SAVINGS THIS MONTH</div>
                <span style={{fontFamily:MONO,fontSize:18,fontWeight:800,color:saving>=0?"#34D399":"#F87171",...blurStyle}}>{rp(saving)}</span>
              </div>
              <div style={{textAlign:"right"}}>
          ...
          <div style={{minWidth:"100%",padding:"20px 22px",background:bg1,position:"relative",overflow:"hidden",boxSizing:"border-box"}}>
            ...
            <div style={{fontSize:11,color:"rgba(255,255,255,0.55)",fontWeight:700,letterSpacing:1,marginBottom:5}}>TOTAL BALANCE YTD</div>
            <div style={{fontFamily:MONO,fontSize:28,fontWeight:900,color:"#fff",letterSpacing:-0.5,marginBottom:14,...blurStyle}}>{rp(totalBal)}</div>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:14}}>
              <div style={{background:"rgba(52,211,153,0.15)",borderRadius:12,padding:"10px 12px"}}>
...
function UserApp({user,onLogout}){
  ...
  useEffect(()=>{loadData(user.id).then(d=>{setData(d);setDarkMode(!!d.darkMode);});},[]);
